...
import {getAllPharmaBurkina} from '../ServiceWorker/helper';
                    ...
                    <View style={styles.containerPub}>
                        ...
                        <View style={styles.containerForPrice}>
                            <View style={{flex:1, justifyContent: "flex-start"}}>
                                <Text numberOfLines={3} style={styles.price}>{props.ele.addressBP}</Text>
                                <Text numberOfLines={2} style={styles.price}>{props.ele.address}</Text>
...
export default class Faso extends React.Component{
    constructor(props){
        super(props)
        this.state = {
            meta:[],
    ...
    async componentDidMount() {
        ...
        let scrap = await getAllPharmaBurkina();
            ...
            return (
                <View style={{flex: 1}}>
                    <Header
                        ...
                        centerComponent={{ text: "Ouagadougou", style: { color: '#fff' } }}
                        containerStyle={{
