...
import {getAllPharmaYaounde} from '../ServiceWorker/helper';
...
export default class Yaounde extends React.Component{
    constructor(props){
        super(props)
        this.state = {
            meta:[],
    ...
    async componentDidMount() {
        ...
        let scrap = await getAllPharmaYaounde();
            ...
            return (
                <View style={{flex: 1}}>
                    <Header
                        ...
                        centerComponent={{ text: "Yaoundé", style: { color: '#fff' } }}
                        containerStyle={{
